...
import { Container, Title, Label, Input, Button, ButtonText, Link, LinkText, ErrorText, InputContainer, EyeButton } from "./styles";
  ...
  return (
    ...
    <InputContainer>
      <Input 
        ...
        placeholderTextColor="#e0c3a0"
        keyboardType="email-address"
        autoCapitalize="none"
      />
      {/* Espaço vazio ou ícone de carta se quiser futuramente */}
    </InputContainer>
